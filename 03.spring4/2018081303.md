...
예를 들어 MemberDao를 상속받은 CacheMemberDao를 사용해서 < bean>을 설정하고 @Autowired 애노테이션을 MemberDao 타입의 필드에 설정했다고 하면?
~~~
...
~~~
CacheMemberDao 클래스는 MemberDao 클래스를 상속받았으므로, CacheMemberDao 객체를 MemberDao 타입 변수에 할당 가능하다 
